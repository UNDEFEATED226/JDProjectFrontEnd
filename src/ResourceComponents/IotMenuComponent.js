...
class IotMenuResourceComponent extends React.Component{
    ...
    render(){
       return(
        <div>
        <br></br>
        <h3 className="text-center font-weight-bold text-secondary">物管平台菜单</h3>
        ...
        <div className="text-center color-font font-weight-bold">共{this.state.totalElements}资源(物管平台菜单)</div>
    </div>
       )
    }
}
