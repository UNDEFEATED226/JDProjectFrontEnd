...
class govApiComponent extends React.Component{
    ...
    render(){
       return(
        <div>
        <br></br>
        <h3 className="text-center font-weight-bold text-secondary">能源平台政府侧API</h3>
        ...
        <table className="table f-size table-boarder" style={{color:"grey"}}> 
           <thead className="text-justify">
                <tr>
                  ...
                  <th style={{columnWidth:"300px"}}>操作</th>
                </tr>
                </thead>
             <tbody>
                 {
        ...
        <div className="text-center color-font font-weight-bold">共{this.state.totalElements}资源(能源平台侧政府API)</div>
    </div>
       )
    }
}
